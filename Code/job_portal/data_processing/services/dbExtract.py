...
import django
import json
############################################## python -m data_processing.services.dbExtract #######################################
...
def dbExtract(model_name,id):
    ...
    obj = model_name.objects.get( username='vahidz')
    ...
    return json_formatted_string.__dir__



type(dbExtract(JobApplication,4))